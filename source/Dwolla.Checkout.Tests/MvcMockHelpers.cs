...
namespace Dwolla.Checkout.Tests
{
 ...
 public static HttpContextBase MockHttpContext()
        ...
        public static void SetupRequestUrl(this HttpRequestBase request, string url)
        {
            ...
            mock.Setup(req => req.Unvalidated).Returns(new UnvalidatedRequestValuesTester(request));
    ...
    public class UnvalidatedRequestValuesTester : UnvalidatedRequestValuesBase
    {
        private readonly HttpRequestBase b;

        public UnvalidatedRequestValuesTester(HttpRequestBase b)
        {
            this.b = b;
        }

        public override HttpCookieCollection Cookies => b.Cookies;
        public override HttpFileCollectionBase Files => b.Files;
        public override NameValueCollection Form => b.Form;
        public override NameValueCollection Headers => b.Headers;

        public override string this[string field] => b[field];

        public override string Path => b.Path;
        public override string PathInfo => b.PathInfo;
        public override NameValueCollection QueryString => b.QueryString;
        public override string RawUrl => b.RawUrl;
        public override Uri Url => b.Url;
    }
}